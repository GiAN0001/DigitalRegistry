        ...
        <div>
            <div class="max-w-full">
                <div class="dashboard-grid">
                    {{-- Staff Activity Table (Admin View) --}}
                                            ...
                                            @forelse ($users as $user)
                                                <tr class="bg-sky-100 hover:bg-sky-200 transition-colors duration-200">
                                                    ...
                                                    <td class="px-6 whitespace-nowrap text-center">
                                                        <span
                                                            class="px-2 py-1 inline-flex rounded-full bg-blue-100 text-blue-800">{{ $user->roles->first()->name ?? 'N/A' }}</span>
                                                    </td>
                                                    <td
                    ...
                    {{-- Charts --}}
                    <div class="col-span-1 md:col-span-2 lg:col-span-6 flex flex-col overflow-hidden">

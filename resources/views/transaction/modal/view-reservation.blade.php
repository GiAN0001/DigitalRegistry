        ...
        <div class="max-h-[600px] overflow-y-auto pr-2 space-y-6">
            ...
            <div class="bg-gray-50 rounded-lg p-4 mb-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <p class="text-sm font-semibold text-slate-700" x-text="reservation.id"></p>
                    </div>
                    <div>
            ...
            <div class="bg-gray-50 rounded-lg p-4 mb-6" x-show="reservation.equipments && reservation.equipments.length > 0">
                ...
                <div class="space-y-2">
                    ...
                    <template x-if="reservation.delivered_by_name">
                        <div class="bg-orange-50 rounded-lg p-3 border border-orange-200">
                            <div class="flex justify-between items-center text-sm text-slate-700">
                                <span><strong>Delivered By:</strong> <span x-text="reservation.delivered_by_name"></span></span>
                                <span><strong>Date:</strong> <span x-text="reservation.date_delivered || 'Pending'"></span></span>
                            </div>
                        </div>
                    </template>
                    <template x-if="reservation.returned_by_name">
                        <div class="bg-green-50 rounded-lg p-3 border border-green-200">
                            <div class="flex justify-between items-center text-sm text-slate-700">
                                <span><strong>Returned By:</strong> <span x-text="reservation.returned_by_name"></span></span>
                                <span><strong>Date:</strong> <span x-text="reservation.date_returned || 'Pending'"></span></span>
                            </div>
                        </div>
                    </template>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <template x-if="reservation.created_at">
                        <div>
                            ...
                            <p class="text-sm font-semibold text-slate-700" x-text="reservation.created_at"></p>
                        </div>
                    </template>
                    <template x-if="reservation.transferred_for_payment_by">
                        <div>
                            <p class="text-xs text-gray-500 mb-1">For Payment By</p>
                    ...
                    <template x-if="reservation.for_payment_at">
                        <div>
                            <p class="text-xs text-gray-500 mb-1">Date For Payment</p>
                            <p class="text-sm font-semibold text-slate-700" x-text="reservation.for_payment_at"></p>
                        </div>
                    </template>
                    <template x-if="reservation.transferred_paid_by">
                        <div>
                            <p class="text-xs text-gray-500 mb-1">Paid By</p>
                    ...
                    <template x-if="reservation.paid_at">
                        <div>
                            ...
                            <p class="text-sm font-semibold text-slate-700" x-text="reservation.paid_at"></p>
                        </div>
                    </template>
                    <template x-if="reservation.completed_by">
                        <div>
                            <p class="text-xs text-gray-500 mb-1">Completed By</p>
                            <p class="text-sm font-semibold text-slate-700" x-text="reservation.completed_by"></p>
                        </div>
                    </template>
                    <template x-if="reservation.completed_at">
                        <div>
                            <p class="text-xs text-gray-500 mb-1">Date Completed</p>
                            <p class="text-sm font-semibold text-slate-700" x-text="reservation.completed_at"></p>
                        </div>
                    </template>
                    ...
                    <template x-if="reservation.date_of_cancelled">
                        <div>
                            ...
                            <p class="text-sm font-semibold text-slate-700" x-text="reservation.date_of_cancelled"></p>
                        </div>
                    </template>
                    ...
                    <template x-if="reservation.date_of_rejected">
                        <div>
                            ...
                            <p class="text-sm font-semibold text-slate-700" x-text="reservation.date_of_rejected"></p>
                        </div>
                    </template>
                </div>
            </div>
                ...
                <div class="flex gap-3">
                    <button 
                        @click="
                            $dispatch('close');
                            setTimeout(() => {
                                $dispatch('open-modal', 'reject-reservation');
                                setTimeout(() => {
                                    window.dispatchEvent(new CustomEvent('set-reject-id', { detail: reservation.id }));
                                }, 200);
                            }, 200);
                        "
                ...
                <div class="flex gap-3">
                    <button 
                        @click="
                            $dispatch('close');
                            setTimeout(() => {
                                $dispatch('open-modal', 'cancel-reservation');
                                setTimeout(() => {
                                    window.dispatchEvent(new CustomEvent('set-cancel-id', { detail: reservation.id }));
                                }, 200);
                            }, 200);
                        "
                    ...
                    <button 
                        @click="
                            $dispatch('close');
                            setTimeout(() => {
                                window.dispatchEvent(new CustomEvent('set-paid-id', { detail: reservation.id }));
                                $dispatch('open-modal', 'mark-paid');
                            }, 200);
                        "
                ...
                <div class="flex gap-3">
                    ...
                    <button 
                        @click="
                            $dispatch('close');
                            setTimeout(() => {
                                window.dispatchEvent(new CustomEvent('set-complete-id', { detail: reservation.id }));
                                $dispatch('open-modal', 'complete-reservation');
                            }, 200);
                        "
                        class="inline-flex items-center px-4 py-2 bg-green-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-green-700 focus:bg-green-700 active:bg-green-800 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition ease-in-out duration-150"
                    >

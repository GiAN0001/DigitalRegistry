...
<head>
    ...
    <title>Equipment Delivery Confirmation</title>
    <style>
        ...
        <tr>
            <td align="center" style="padding: 0;">
                <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); max-width: 100%;">
                    ...
                    {{-- Header --}}
                    <tr>
                        <td class="header-td" style="background-color: #10b981; padding: 30px 40px; text-align: center;">
                            <h1 style="color: #ffffff; margin: 0; font-size: 24px; font-weight: bold;">Equipment Delivery Confirmed</h1>
                            <p style="color: #a7f3d0; margin: 8px 0 0 0; font-size: 14px;">Your equipment has been successfully delivered</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="body-td" style="padding: 40px;">
                            ...
                            <p style="color: #475569; font-size: 14px; margin: 0 0 30px 0; line-height: 1.6;">
                                We are pleased to inform you that your equipment for reservation <strong>#{{ $reservation->id }}</strong> has been successfully <strong style="color: #10b981;">delivered</strong>.
                            </p>

                            {{-- Status Badge --}}
                            <table role="presentation" cellpadding="0" cellspacing="0" style="margin: 0 0 30px 0;">
                                <tr>
                                    <td style="background-color: #ecfdf5; border: 1px solid #a7f3d0; border-radius: 20px; padding: 8px 20px;">
                                        <span style="color: #059669; font-size: 13px; font-weight: 600;">● Delivered</span>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color: #f8fafc; border-radius: 8px; margin: 0 0 20px 0;">
                                <tr>
                                    <td style="padding: 20px;">
                                        <h3 style="color: #1e293b; font-size: 16px; margin: 0 0 15px 0; font-weight: bold;">Delivery Information</h3>
                                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                            <tr class="schedule-row">
                                                <td width="50%" style="padding: 5px 0; padding-right: 10px;">
                                                    <p style="color: #94a3b8; font-size: 11px; margin: 0;">Delivered By</p>
                                                    <p style="color: #334155; font-size: 14px; margin: 2px 0 0 0; font-weight: 600;">{{ $deliveredByName }}</p>
                                                </td>
                                                <td width="50%" style="padding: 5px 0;">
                                                    <p style="color: #94a3b8; font-size: 11px; margin: 0;">Delivery Date & Time</p>
                                                    <p style="color: #334155; font-size: 14px; margin: 2px 0 0 0; font-weight: 600;">{{ $deliveryDate }}</p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color: #f8fafc; border-radius: 8px; margin: 0 0 20px 0;">
                                <tr>
                                    <td style="padding: 20px;">
                                        <h3 style="color: #1e293b; font-size: 16px; margin: 0 0 15px 0; font-weight: bold;">Equipment Delivered</h3>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color: #fffbeb; border: 1px solid #fde68a; border-radius: 8px; margin: 0 0 30px 0;">
                                <tr>
                                    <td style="padding: 20px;">
                                        <p style="color: #92400e; font-size: 14px; font-weight: 600; margin: 0 0 8px 0;">⚠️ Important Reminder</p>
                                        <p style="color: #a16207; font-size: 13px; margin: 0; line-height: 1.5;">
                                            Please ensure all equipment is in good condition upon receipt. If you notice any damage or concerns with any items, please contact us immediately at the barangay hall.
                                        </p>
                                    </td>
                                </tr>
                            </table>

        ...
        <tr>
            <td align="center">
                <table width="600" cellpadding="0" cellspacing="0" class="main-table" style="background:#fff; border-radius:12px; overflow:hidden; box-shadow:0 4px 6px rgba(0,0,0,0.1); max-width:100%;">
                    <tr>
                        <td style="background:#ef4444; padding:30px 20px; text-align:center;">
                            <h1 style="color:#fff; margin:0; font-size:24px; font-weight:bold;">Reservation Cancelled</h1>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:30px 20px;">
                            ...
                            <p style="color:#475569; font-size:14px; margin:0 0 20px 0;">
                                We regret to inform you that your facility reservation request has been <strong style="color:#ef4444;">cancelled</strong>.
                            </p>
                            ...
                            <h3 style="color:#ef4444; font-size:16px; margin:0 0 10px 0; font-weight:bold;">Reason for Cancellation</h3>

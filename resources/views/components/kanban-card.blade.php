@props([
    ...
    'textColor' => 'text-gray-700',  // Add this line
    'releasedBy' => null,
    'rejectedBy' => null,
    'reason' => null
])
...
<div class="bg-slate-50 rounded-xl p-8">
    <div class="flex justify-between items-start mb-8">
        ...
        <div class="relative">
            ...
            <div class="dropdown-menu hidden w-36 bg-white rounded-xl shadow-xl border border-gray-200 z-[9999] overflow-hidden">
                ...
                <button class="w-full text-left px-4 py-3 hover:bg-gray-300 text-xs font-medium">Signed</button>
                <button class="w-full text-left px-4 py-3 hover:bg-gray-300 text-xs font-medium">Cancelled</button>
            </div>
        </div>
    </div>
    ...
    <div>
        ...
        <div class="inline-flex items-center gap-3 {{ $dateColor }} px-3 py-2 rounded-lg text-xs font-semibold {{ $textColor }}">

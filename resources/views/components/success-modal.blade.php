...
<x-modal :name="$name" maxWidth="max-w-lg" focusable>
    <div class="p-8 sm:p-12">
        ...
        <div class="flex justify-center">
            <button
                type="button"
                @click="$dispatch('close')"
                class="w-full sm:w-auto px-10 py-3 bg-red-600 text-white text-lg font-semibold rounded-xl hover:bg-red-700 transition-colors"
            >
                Close
            </button>
        </div>

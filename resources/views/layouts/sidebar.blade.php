    ...
    <nav class="flex-1 space-y-2 overflow-y-auto px-2">
        ...
        @hasanyrole('admin|help desk|super admin')
            <x-sidebar.dropdown title="Transactions" :active="request()->routeIs('transaction.document*', 'reservations.*')">
                ...
                {{ request()->routeIs('transaction.document*') ? 'bg-blue-700 text-white' : 'text-slate-700 hover:text-white hover:bg-blue-700' }}">
                        Document Requests
                    </a>
                </li>
                <li>
            ...
            <div class="pt-6 mt-2">
                ...
                <x-sidebar.dropdown title="Social Services" :active="request()->routeIs('services.*')">
                    <x-slot name="icon">
                        <x-lucide-heart-handshake
                            class="w-5 h-5 {{ request()->routeIs('services.*') ? 'text-white' : '' }}" />
                    </x-slot>
                ...
                {{-- Lookup & Add Item Button --}}
                    <a
                        ...
                        class="flex items-center w-full p-2 mb-2 text-sm font-medium transition duration-75 rounded-lg
